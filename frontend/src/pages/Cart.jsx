...
const Cart = () => {
  const { products, currency, cartItems, updateQuantity, navigate, requireAuth } = useContext(ShopContext);
    ...
    <div className="border-t pt-14">
      ...
      {cartData.length === 0 ? (
        <div className="text-center py-20">
          <img src={assets.cart_icon} alt="Empty cart" className="w-20 h-20 mx-auto mb-4 opacity-30" />
